...
export default function RightBar(){
    return (
        ...
        <RightTrendBox>
            ...
            <p>3. 홈 페이지 : 게시물 작성, 사진첨부, 첨부사진 표시, 첨부사진 삭제, 이모티콘 기입, 게시글 권한 식별, 권한 게시글 삭제, 권한 게시글 수정, 게시물 만든 시간 표시(just now,m,h,d...), 게시물 작성자 이름 표시.</p>
            <p>4. 프로필 페이지 : 프로필 사진,글 업로드 및 수정, 프로필 이미지 timeline, leftbar에 첨부.</p>
